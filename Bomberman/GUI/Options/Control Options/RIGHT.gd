...
"""
Method name: _on_RIGHT_pressed();
Arguments: N/A
Function change the key that is corresponding to the parent node's ui_right action
"""
func _on_RIGHT_pressed():
	...
	get_node("/root/ConfigurationNode").change_and_commit(player_id,"right",code)
